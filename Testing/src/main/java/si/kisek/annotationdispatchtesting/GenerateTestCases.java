...
public class GenerateTestCases {
    ...
    public static void main(String[] args) {
        ...
        for (int i : new int[] {1, 2, 3, 5, 10, 15, 20}) {
            String str = Generator.generateTestClass("Parameters" + i, 1, 5, 10, i, 3, 3);
        ...
        for (int i : new int[] {1, 2, 3, 4, 5, 8, 10}) {
            String str = Generator.generateTestClass("Classes" + i, 1, 5, 10, 5, i, 3);
        ...
        for (int i : new int[] {1, 2, 3, 5, 10, 15, 20}) {
            String str = Generator.generateTestClass("Methods" + i, i, 5, 10, 5, 3, 3);
